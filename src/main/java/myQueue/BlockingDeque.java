...
/**
 * Created by Nzm on 2018/2/27.
 */
public class BlockingDeque {
    //阻塞队列，FIFO
    //private static LinkedBlockingQueue<Integer> concurrentLinkedQueue = new LinkedBlockingQueue<>(3);
    private static ArrayBlockingQueue<Integer> concurrentLinkedQueue = new ArrayBlockingQueue<>(3);
